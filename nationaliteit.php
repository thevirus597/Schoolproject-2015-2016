  ...
  <button type="submit" class="btn btn-info btn-lg">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="rijbewijs.php?id=<?php echo $id ?>"><i ></i>Aanvraag Rijbewijs</a>
						   ...
						   <li  >
                        <a   href="geboorte.php?id=<?php echo $id ?>"><i ></i>Geboorte akte</a>
                    </li>
                      <li  >
                        <a class="active-menu"  href="nationaliteit.php?id=<?php echo $id ?>"><i ></i>Nationaliteits verklaring</a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Nationaliteits verklaring Uitprinten</h2>


                     <div class="nationaliteit">
                     <img src="Fdoc/nationaliteit.png" class= "img-responsive center-block" ></br>
                     </div>

                     <a href="docs/nationaliteit.php?id=<?php echo $id ?>" class="btnn btn-info btn-lg">
