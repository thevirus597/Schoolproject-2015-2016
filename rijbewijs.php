  ...
  <button type="submit" class="btn btn-info btn-lg">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="rijbewijs.php?id=<?php echo $id ?>"><i ></i>Aanvraag Rijbewijs</a>
                    </li>
						   <li  >
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h3>Een aanvraag doen voor een niewe rijbewijs?</h3>


                     <div class="rijbewijs">
                     <img src="Fdoc/rijbewijs.png" class= "img-responsive center-block" ></br>
                     </div>


                     <a href="docs/rijbewijsaanvraag.php?id=<?php echo $id ?>" class="btnr btn-info btn-lg">
