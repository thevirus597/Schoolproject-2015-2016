  ...
  <button type="submit" class="btn btn-info btn-lg">
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu"  href="uitreksel.php?id=<?php echo $id ?>"><i ></i>Uitreksel</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Uitprinten van een uitreksel</h2>


                     <div class="uitreksel">
                     <img src="Fdoc/uitreksel.png" class= "img-responsive center-block" ></br>
                     </div>



                     <a href="docs/uitreksel.php?id=<?php echo $id ?>" class="btnu btn-info btn-lg">
